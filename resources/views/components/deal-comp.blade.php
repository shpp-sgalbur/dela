    ...
    <div class ="flex flex-row   px-2 " >
        ...
        <div class="flex justify-end w-full ">
            ...
            <form method="post" > 
                ...
                @method('DELETE')
                @csrf
                <button formaction="{{route('dealDestroy',['id'=>$deal->id,'category'=>$category])}}" class ="cursor-pointer border-2 border-green-500 border-solid  p-1 rounded-lg bg-red-300  h-8 w-8">
