<form name="form_find" method="post" action="find.php" >
...
Все поля заполнять не обязательно.</p>
  ...
  <input type="submit" name="Submit2" value=" Искать" class ="cursor-pointer border-2 border-green-500 border-solid  p-1 rounded-lg bg-green-300  h-8 ">  
  </div>
</form>
