    ...
    @if($seconDeal)
        ...
        <div class ="h-auto hover:bg-yellow-200 border-solid border-green-500 border-4 rounded-2xl box-border m-2  bg-green-100">
            ...
            <form method="post" class="flex justify-center ">    
                @csrf
                <button 
                    formaction="{{route('voteStore',['winDeal'=>$firstDeal, 'loserDeal'=>$seconDeal,'category'=>$category])}}" 
        ...
        <div class ="h-auto hover:bg-yellow-200 border-solid border-green-500 border-4 rounded-2xl box-border m-2 bg-green-100" >
            ...
            <form method="post" class="flex justify-center ">  
                @csrf
                <button 
                    formaction="{{route('voteStore',['winDeal'=>$seconDeal, 'loserDeal'=>$firstDeal,'category'=>$category])}}" 
